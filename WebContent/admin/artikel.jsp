...
<div class="col-sm-12 main">
	<div class="row">
		...
		<div class="col-xs-2 pull-right">
			<a
				href="<%=request.getServletContext().getInitParameter("BASE_URL") %>/artikel?act=add"
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<div class="artikel-list">
				<a
					href="<%=request.getServletContext().getInitParameter("BASE_URL") %>/artikel?act=delete&url=<%=artikels.get(i).getSeoUrl() %>"
					class="btn btn-lg btn-circle marginable pull-right glyphicon glyphicon-remove-sign"
					alt="delete"></a> <a
					href="<%=request.getServletContext().getInitParameter("BASE_URL") %>/artikel?act=edit&url=<%=artikels.get(i).getSeoUrl() %>">
